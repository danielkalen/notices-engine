...
action:"<div class='Notice-actions-item button_{{name}} {{promiseAction}}' data-name='{{name}}'> <div class='Notice-actions-item-text'>{{label}}</div> </div>"};h.instances=b.prototype.allInstances;h.context=document.body;Subnotice.version="2.2.0";window.notify=h;return h.Notice=b})(jQuery);
