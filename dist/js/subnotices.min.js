...
g.prototype.reveal=function(){return this.notice=new Notification(this.title,{body:this.text})};b(window).on("click",".subnotice-close",function(){return b(this).parent().data("Subnotice").destroy(0)})})(jQuery)}).call(this);
