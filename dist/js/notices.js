...
(function($) {
  var Notice, actionMarkup, notify;
  if ($('.notices').length === 0) {
  ...
  Notice = function(arg) {
    ...
    if (template) {
      ...
      this.el = $("<div class='notice'> <div class='notice-title'>" + title + "</div> <div class='notice-message'>" + text + "</div> <div class='notice-actions" + extraActionsClass + "'>" + actionMarkup[this.type] + "</div> <div class='notice-altAction'>" + altAction + "</div> </div>");
    }
  ...
  return Notice.actionMarkup = actionMarkup;
})(jQuery);
